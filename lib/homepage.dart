                                  ...
                                  ? Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          // Buat path audio yang konsisten
                                          String audioPath =
                                              'music/${_formatAudioFileName(hits[index]['title']!)}.mp3';
                                          //ganti menjadi path music
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) => MusicPlayer(
                                                songTitle: hits[index]
                                                    ['title']!,
                                                artistName: hits[index]
                                                    ['artist']!,
                                                imagePath: hits[index]
                                                    ['image']!,
                                                audioPath: audioPath,
                                              ),
                                            ),
                                        ...
                                        child: buildAlbumCard(
                                          ...
                                          subtitle: hits[index]['artist']!,
                                          imagePath: hits[index]['image']!,
                                        ),
                                      ),
                                    )
                                  : const SizedBox.shrink(),
    ...
    children: [
      buildArtistInfoCard(
        ...
        profileImage: CircleAvatar(
          ...
          backgroundImage: AssetImage('assets/the_weeknd.png'), // Ganti dengan nama file gambar The Weeknd
        ),
      ),
      const SizedBox(width: 10),
                        buildArtistInfoCard(
                          artistName: "Bernadya",
                          songs: ["1.Satu Bulan", "2. Kini Mereka Tau", "3.Kata Mereka ini Berlebihan"],
                          profileImage: CircleAvatar(
                            radius: 30,
                            backgroundColor: Colors.grey[700],
                            child: const Text("J",
      ...
      buildArtistInfoCard(
        ...
        profileImage: CircleAvatar(
          radius: 30,
          backgroundColor: Colors.grey[700],
          backgroundImage: AssetImage('assets/justin_bieber.png'), // Ganti dengan nama file gambar Justin Bieber
        ),
      ),
    ],
  ),
                                  ...
                                  ? Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          // Buat path audio yang konsisten
                                          String audioPath =
                                              'music/${_formatAudioFileName(newAdd[index]['title']!)}.mp3';
                                          //ganti menjadi path music
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) => MusicPlayer(
                                                songTitle: newAdd[index]
                                                    ['title']!,
                                                artistName: newAdd[index]
                                                    ['artist']!,
                                                imagePath: newAdd[index]
                                                    ['image']!,
                                                audioPath: audioPath,
                                              ),
                                            ),
                                        ...
                                        child: buildAlbumCard(
                                          ...
                                          height: 100,
                                          borderRadius: 14,
                                          title: newAdd[index]['title']!,
                                          subtitle: newAdd[index]['artist']!,
                                          imagePath: newAdd[index]['image']!,
                                        ),
                                      ),
                                    )
                                  : const SizedBox.shrink(),
                                  ...
                                  ? Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          // Buat path audio yang konsisten
                                          String audioPath =
                                              'music/${_formatAudioFileName(pop[index]['title']!)}.mp3';
                                          //ganti menjadi path music
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                        ...
                                        child: buildAlbumCard(
                                          ...
                                          subtitle: pop[index]['artist']!,
                                          imagePath: pop[index]['image']!,
                                        ),
                                      ),
                                    )
                                  : const SizedBox.shrink(),
                                  ...
                                  ? Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          // Buat path audio yang konsisten
                                          String audioPath =
                                              'music/${_formatAudioFileName(localMusic[index]['title']!)}.mp3';
                                          //ganti menjadi path music
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) => MusicPlayer(
                                                songTitle: localMusic[index]
                                                    ['title']!,
                                                artistName: localMusic[index]
                                                    ['artist']!,
                                                imagePath: localMusic[index]
                                                    ['image']!,
                                                audioPath: audioPath,
                                              ),
                                            ),
                                        ...
                                        child: buildAlbumCard(
                                          ...
                                          height: 100,
                                          borderRadius: 14,
                                          title: localMusic[index]['title']!,
                                          subtitle: localMusic[index]['artist']!,
                                          imagePath: localMusic[index]['image']!,
                                        ),
                                      ),
                                    )
                                  : const SizedBox.shrink(),
                                  ...
                                  ? Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          // Buat path audio yang konsisten
                                          String audioPath =
                                              'music/${_formatAudioFileName(sadMusic[index]['title']!)}.mp3';
                                          //ganti menjadi path music
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) => MusicPlayer(
                                                songTitle: sadMusic[index]
                                                    ['title']!,
                                                artistName: sadMusic[index]
                                                    ['artist']!,
                                                imagePath: sadMusic[index]
                                                    ['image']!,
                                                audioPath: audioPath,
                                              ),
                                            ),
                                        ...
                                        child: buildAlbumCard(
                                          ...
                                          height: 100,
                                          borderRadius: 14,
                                          title: sadMusic[index]['title']!,
                                          subtitle: sadMusic[index]['artist']!,
                                          imagePath: sadMusic[index]['image']!,
                                        ),
                                      ),
                                    )
                                  : const SizedBox.shrink(),
                                  ...
                                  ? Padding(
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          // Buat path audio yang konsisten
                                          String audioPath =
                                              'music/${_formatAudioFileName(relaxing[index]['title']!)}.mp3';
                                          //ganti menjadi path music
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) => MusicPlayer(
                                                songTitle: relaxing[index]
                                                    ['title']!,
                                                artistName: relaxing[index]
                                                    ['artist']!,
                                                imagePath: relaxing[index]
                                                    ['image']!,
                                                audioPath: audioPath,
                                              ),
                                            ),
                                        ...
                                        child: buildAlbumCard(
                                          ...
                                          height: 100,
                                          borderRadius: 14,
                                          title: relaxing[index]['title']!,
                                          subtitle: relaxing[index]['artist']!,
                                          imagePath: relaxing[index]['image']!,
                                        ),
                                      ),
                                    )
                                  : const SizedBox.shrink(),
...
final List<Map<String, String>> hits = [
  {
    'title': 'DJ Jangan Salah Pasangan',
    'artist': 'Ismail',
    'image': 'assets/images/closed doors.jpg',
  },
  {
...
//new add
final List<Map<String, String>> newAdd = [
  {
    'title': 'Die With A Smile',
    'artist': 'Ismail',
    'image': 'assets/images/closed doors.jpg',
...
//pop
final List<Map<String, String>> pop = [
  {
    'title': 'Drunk Text',
    'artist': 'Ismail',
    'image': 'assets/images/closed doors.jpg',
...
//local music
final List<Map<String, String>> localMusic = [
  {
    'title': 'kata Mereka ini Berlebihan',
    'artist': 'Bernadya',
    'image': 'assets/images/kata mereka ini berlebihan.jpg',
...
//sad music
final List<Map<String, String>> sadMusic = [
  {
...
//relaxing
final List<Map<String, String>> relaxing = [
  {
    'title': 'Golden Hour',
    'artist': 'Ismail',
    'image': 'assets/images/closed doors.jpg',
